...
import com.example.onlineshop.view.makeOrder.MakeOrderActivity
import com.example.onlineshop.view.cart.adapter.CartAdapter
...
class CartFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnMakeOrder.setOnClickListener {
            ...
            intent.putExtra(Constants.PRODUCT_DATA, (viewModel.topProductData.value ?: emptyList()) as Serializable
            )
